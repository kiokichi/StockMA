...
<body>
    ...
    <div class="container">
        <div class="content-left">
            <p> “The four most dangerous words in investing are:
                <b>‘this time it’s different.'”</b> <br>
                Get all the content and information about Stock-Market at one place
            </p>
        ...
        <div class="home-articles">
            <div class>
                <h2 class="h2"><a href="https://www.moneycontrol.com/stocksmarketsindia/#maindindi">News</a></h2>
            </div>
        </div>
    ...
    <iframe src='https://webchat.botframework.com/embed/ShareMarketQna-bot?s=wImCP2tlZZA.kW-SYsUwj1ON66Ioy1B_evtgLnbSSL7Dw2-tJfKnotE'></iframe>
    </div>
    <!-- the main body of the website ends here -->

    <footer class="flex-all-center">
        <pre>&copy;All rights are reserved  <a href="https://www.vecteezy.com/free-vector/stock-market">Stock Market Vectors by Vecteezy</a>  <a href="https://www.nuvamawealth.com/insight/articles">Articles by nuvama</a> <a href="https://www.moneycontrol.com/stocksmarketsindia/">Stock related news by money control</a> </pre>
    </footer>
</body>
